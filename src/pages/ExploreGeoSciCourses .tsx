  ...
  return (
    <div>
      <Container className="bg-base-200 flex flex-col ">
        <Navbar />
        <h1 className="text-3xl font-semibold text-green-300 mb-3 text-center">Explore Universities with Geo Science Courses</h1>
...
export default ExploreGeoSciCourses;
