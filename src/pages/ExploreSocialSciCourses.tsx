  ...
  return (
    <div>
      <Container className="bg-base-200 flex flex-col ">
        <Navbar />
        <h1 className="text-3xl mb-3 text-center">Explore Universities with Social Science Courses</h1>
...
export default ExploreSocialSciCourses;
