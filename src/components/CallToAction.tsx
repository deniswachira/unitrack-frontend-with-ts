    ...
    return (
        <div className="bg-base-200 text-white py-10">
            <div className="container mx-auto text-center">
                <h2 className="text-4xl text-green-700 font-bold mb-4">Ready to Start Learning?</h2>
                <p className="text-lg text-blue-500 mb-6">Join us today and explore a world of knowledge!</p>
